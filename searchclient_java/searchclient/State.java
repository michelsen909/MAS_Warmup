...
public class State {
    ...
    public static int agentRow;
    public static int agentCol;
    ...
    public State(State parent) {
        ...
        MAX_ROW = SearchClient.rows;
        MAX_COL = SearchClient.cols;
    ...
    private State ChildState() {
        ...
        for (int row = 0; row < MAX_ROW; row++) {
            //System.arraycopy(SearchClient.walls[row], 0, copy.walls[row], 0, MAX_COL);
            System.arraycopy(this.boxes[row], 0, copy.boxes[row], 0, MAX_COL);
            //System.arraycopy(SearchClient.goals[row], 0, copy.goals[row], 0, MAX_COL);
        }
        return copy;
    }
